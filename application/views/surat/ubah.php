      ...
      <div class="tile-body">
        <form method="post" action="<?php echo base_url('surat/aksi_ubah'); ?>">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" required placeholder="Masukan Tanggal" style="background-color: white;" name="data[tanggal]" id="tanggal" readonly value="<?php echo $this->pustaka->tanggal_indo($data['surat']->tanggal); ?>">
          </div>
